...
namespace Player
{
    internal class FirstPersonAudio : MonoBehaviour
    {
        ...
        private void SetPlayingMovingAudio(AudioSource audioToPlay)
        {
            ...
            foreach (AudioSource audio in MovingAudios.Where(audio => audio != audioToPlay && audio != null))
            {
                audio.Pause();
            }
        ...
        {
            PlayRandomClip(crouchStartAudio, crouchStartSFX);
        }
